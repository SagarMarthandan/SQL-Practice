...
### 3. Sample Databases (Complex Schemas)
*   **Sakila Database**:
...
### 4. Advanced Data Warehousing (Azure SQL DW)
...
2.  **Practice**: Open the function-specific scripts (String Functions, Logical Operators) to see examples and try writing your own variations.
